...
/**
 * sub_001D9360
 * Original: 0x001D9360 - 0x001D9414 (180 bytes, 42 insns)
...
loc_001D9360:
    ...
    if ((eax == 0)) goto loc_001D93A4; /* je: equal / zero */

loc_001D938B:
    xmm3.f[0] = MEMF(0x3B168C); /* movss */
    memcpy(xmm4.b, xmm3.b, 16); /* movaps */
    xmm3.f[0] = xmm3.f[0] / MEMF(esi + 0x80); /* divss */
    xmm4.f[0] = xmm4.f[0] / xmm0.f[0]; /* divss */
    goto loc_001D93AF;

loc_001D93A4:
    xmm3.f[0] = MEMF(esi + 0x80); /* movss */
...
loc_001D93AF:
    ...
    if (TEST_Z(eax, eax)) goto loc_001D9410; /* je: equal / zero */
