...
/**
 * sub_00147F90
 * Original: 0x00147F90 - 0x0014807A (234 bytes, 52 insns)
...
loc_00147F90:
    ...
    MEM8(esp + 0x48) = 8;
    MEM8(esp + 0x49) = 1;
    if (TEST_Z(LO8(eax), LO8(eax))) goto loc_00148039; /* je: equal / zero */
...
loc_0014805E:
    ...
    MEM32(ebx + 0xC4) = eax;
    POP32(esp, esi);
    if (TEST_Z(eax, eax)) goto loc_00148073; /* je: equal / zero */
